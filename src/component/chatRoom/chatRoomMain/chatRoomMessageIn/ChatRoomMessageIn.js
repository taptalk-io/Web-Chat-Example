...
var ChatRoomMessageIn = (props) => {
  ...
  return (
    <div className="chat-room-message-in-wrapper" id={`message-${singleChatDataProps.localID}`} onTouchStart={onTouchStartEvent} onTouchEnd={onTouchEndEvent}>
...
export default connect(mapStateToProps, mapDispatchToProps)(ChatRoomMessageIn);
